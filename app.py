...
purchase_list = db["purchaselist"]
item = db["item"]
specificItem = db["specificItem"] #Instructions on how to recycle specific item
...
class insertRecipt(Resource):
    def post(self):
        postedData = request.get_json()
        username = postedData["username"]
        password = postedData["password"]
        date = postedData["date"]
        items = postedData["purchaseList"]
